...
void CatSetTable(const char* table[N]) {
  const char* SampleTable[N] = {
      "\00",  "\01",  "\02",  "\03",  "\04",  "\05",  "\06",  "\07",  "\b",
      "\t",   "\n",   "\v",   "\014", "\015", "\016", "\017", "\020", "\021",
  ...
  memcpy(table, SampleTable, sizeof SampleTable);
}

void CatSetNonPrintable(const char* table[N]) {
